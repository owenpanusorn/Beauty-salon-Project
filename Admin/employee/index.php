            ...
            <div class="box">
              <div class="box-header">
                ...
                <div class="box-tools pull-right">
                  ...
                  <button type="button" class='btn btn-success kanitB' onclick="window.location.href='addemployee/'"> <i class="fa fa-user-plus"></i> เพิ่มรายชื่อพนักงาน</button>
                </div>
              </div>
                  ...
                  <tbody>
                    ...
                    ?>
                      <tr class="kanitB">
                        ...
                        <td><?php echo $row["cre_emp_date"] . ' ' .  $row["cre_emp_time"]  ?></td>
                        <td><a href="editemployee?update_id=<?php echo $row['uuid'] ?>" class="btn btn-warning"><i class="fa fa-pencil-square-o"></i> แก้ไขข้อมูล</a></td>
