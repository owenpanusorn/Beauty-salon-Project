...
<head>
  ...
  <title>Booking list | Beautiful Salon</title>
...
<div class="wrapper">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="pages/layout/top-nav.html"><i class="fa  fa-info"></i>ข้อมูลการจองคิว</a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Booking list
        <small>รายการการจองคิว</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="index.php"><i class="fa fa-home"></i> Home</a></li>
        <li class="active">ฺBooking list</li>
      </ol>
    </section>
    ...
    <div class="row">
        ...
        <div class="box box-success">
            <div class="box-header">
              <h3 class="box-title">Data Table Booking list</h3>
