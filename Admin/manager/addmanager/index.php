...
<<<<<<< Updated upstream:Admin/emp/serv/addserv/index.php
...
>>>>>>> Stashed changes:Admin/manager/addmanager/index.php
...
if (isset($_REQUEST['btn_insert'])) {
  ...
  if (empty($username)) {
    ...
    $errorMsg = "กรุณากรอกเบอร์โทรให้ครบ 10 หลัก";
  } else {
    try {
      if (!isset($errorMsg)) {

        $insert_mng = $db->prepare("INSERT INTO tb_manager(uuid, username, password ,fname, lname, nphone, cre_mng_date, cre_mng_time) VALUES (:uuid,  :username, :password, :firname, :lasname, :nnphone, :cre_mng_date, :cre_mng_time)");
        $insert_mng->bindParam(':uuid', $myuuid);
        $insert_mng->bindParam(':username', $username);
        $insert_mng->bindParam(':password', $hashed_password);
        $insert_mng->bindParam(':firname', $fname);
        $insert_mng->bindParam(':lasname', $lname);
        $insert_mng->bindParam(':nnphone', $numberphone);
        $insert_mng->bindParam(':cre_mng_date', $date);
        $insert_mng->bindParam(':cre_mng_time', $newtime);

        if ($insert_mng->execute()) {
          $insertMsg = "เพิ่มผู้จัดการสำเร็จ . . .";
...
<head>
  ...
  <title>ผู้จัดการ | Beautiful Salon</title>
  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <h1 class="kanitB">
          เพิ่มผู้จัดการ
          <!-- <small class="kanitB"><b>เพิ่มรายชื่อลูกค้า</b></small> -->
        </h1>
        <ol class="breadcrumb kanitB">
          <li><a href="../../index.php"><i class="fa fa-home"></i> หน้าแรก</a></li>
          <li><a href="../">ผู้จัดการ</a></li>
          <li class="active">เพิ่มผู้จัดการ</li>
        </ol>
      </section>
              ...
              <div class="box box-primary">
                ...
                <div class="box-body">
                  ...
                  <div class="box-footer">
                    <button type="submit" name="btn_insert" class="btn btn-success"> <i class="fa fa-user-plus"></i> เพิ่มผู้จัดการ</button>
                  </div>
                </div>
                <!-- /ข้อมูลส้วนตัว -->
              </div>
