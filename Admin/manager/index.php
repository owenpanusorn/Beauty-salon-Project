...
if (isset($_REQUEST['del_id'])) {
  $id = $_REQUEST['del_id'];
  // echo $id;
  $del_login = $db->prepare("DELETE FROM tb_manager WHERE uuid = :id ");
          ...
          <div class="col-xs-12">
            <div class="box">
              <div class="box-header">
                <h3 class="box-title kanitB">ตารางข้อมูลผู้จัดการ</h3>
                <div class="box-tools pull-right">
                  <button type="button" class="btn btn-box-tool" data-widget="collapse">
                    <i class="fa fa-minus"></i>
                  </button>
                  <button type="button" class='btn btn-success kanitB' onclick="window.location.href='addmanager/'"> <i class="fa fa-user-plus"></i> เพิ่มผู้จัดการ</button>
                </div>
              </div>
              ...
              <div class="box-body">
                <table id="example1" class="table table-bordered table-striped kanitB">
                  ...
                  <tbody>
                    <?php
                    $result = $db->prepare('SELECT * from tb_manager');
                    $result->execute();
                    ...
                    ?>
                      <tr class="kanitB">
                        ...
                        <td width='60'>
                          <a href="editmanager?update_id=<?php echo $row['uuid'] ?>" class="btn btn-warning">
                            <i class="fa fa-pencil-square-o"></i> แก้ไขข้อมูล</a>
                        </td>
                        <td width='60'><a href="?del_id=<?php echo $row['uuid'] ?>" class='btn btn-danger' onClick="return confirm('คุณต้องการที่จะลบข้อมูลนี้หรือไม่ ?');"> <i class="glyphicon glyphicon-trash"></i> ลบข้อมูล</a></td>
