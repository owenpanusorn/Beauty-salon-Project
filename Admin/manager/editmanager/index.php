...
if (isset($_REQUEST['update_id'])) {
  try {
    ...
    $qry = $db->prepare("select * from tb_manager where uuid = :uuid");
...
if (isset($_REQUEST['btn_update'])) {
  try {
    ...
    if (!isset($errorMsg)) {
      $update_mng = $db->prepare('update tb_manager set username = :usernameup,password = :passwordup,fname = :fnameup,lname = :lnameup,nphone = :numberphoneup,up_mng_date = :up_mng_dateup,up_mng_time = :up_mng_timeup where uuid = :uuidedit');

      $update_mng->bindParam(':usernameup', $username);
      $update_mng->bindParam(':passwordup', $pass);
      $update_mng->bindParam(':fnameup', $fname);
      $update_mng->bindParam(':lnameup', $lname);
      $update_mng->bindParam(':numberphoneup', $newphone);
      $update_mng->bindParam(':up_mng_dateup', $date);
      $update_mng->bindParam(':up_mng_timeup', $newtime);
      $update_mng->bindParam(':uuidedit', $uuidup);

      if ($update_mng->execute()) {

        $insertMsg = "อัปเดตข้อมูลผู้จัดการสำเร็จ . . .";
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        ...
        <ol class="breadcrumb kanitB">
          ...
          <li class="active">แก้ผู้จัดการ</li>
        </ol>
      </section>
              ...
              <div class="box box-primary">
                ...
                <div class="box-body">
                  ...
                  <div class="box-footer">
                    <button type="submit" name="btn_update" class="btn btn-success"> <i class="fa fa-pencil-square-o"></i> อัปเดตข้อมูลผู้จัดการ</button>
                  </div>
                </div>
                <!-- /ข้อมูลส้วนตัว -->
              </div>
