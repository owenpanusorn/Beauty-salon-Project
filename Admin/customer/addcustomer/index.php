  ...
  if (empty($username)) {
    ...
    try {
      if (!isset($errorMsg)) {       
        ...
        $insert_emp->bindParam(':user', $username);
        ...
        if ($insert_emp->execute()) {
          $insertMsg = "เพิ่มรายชื่อลูกค้าสำเร็จ . . .";
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        ...
        <ol class="breadcrumb kanitB">
          ...
          <li class="active">เพิ่มรายชื่อลูกค้า</li>
        </ol>
      </section>
            ...
            <div class="col-xs-12">
              ...
              <div class="box box-primary">
                ...
                <div class="box-body">
                  ...
                  <div class="form-group">
                    <label>ที่อยู่</label>
                    <textarea class="form-control" name="address" autocomplete="off" rows="3" placeholder="รายละเอียด ..."></textarea>
                  </div>
                  <!-- <div class="form-group">
                ...
                <div class="box-footer">
                  <button type="submit" name="btn_insert" class="btn btn-success"> <i class="fa fa-user-plus"></i> เพิ่มรายชื่อลูกค้า</button>
                </div>
              </div>
              <!-- /ข้อมูลส้วนตัว -->
            </div>
