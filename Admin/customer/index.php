  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <h1 class="kanitB">
          ลูกค้า
          <small class="kanitB"><b>รายชื่อลูกค้า</b></small>
        </h1>
          ...
          <div class="col-xs-12">
            <div class="box">
              <div class="box-header">
                <h3 class="box-title kanitB">ตารางข้อมูลลูกค้า</h3>
                <div class="box-tools pull-right">
                  <button type="button" class="btn btn-box-tool" data-widget="collapse">
                    <i class="fa fa-minus"></i>
                  </button>
                  <button type="button" class='btn btn-success kanitB' onclick="window.location.href='addcustomer/'"> <i class="fa fa-user-plus"></i> เพิ่มรายชื่อลูกค้า</button>
                </div>
              </div>
              ...
              <div class="box-body">
                <table id="example1" class="table table-bordered table-striped kanitB">
                  ...
                  <tbody>
                    <?php
                    $result = $db->prepare('SELECT * from tb_customer');
                    $result->execute();
                    ...
                    ?>
                      <tr class="kanitB">
                        ...
                        <td><?php echo $row["cre_cus_date"] . ' ' . $row["cre_cus_time"] ?></td>
                        <td width="60">
                          <a href="editcustomer?update_id=<?php echo $row['uuid'] ?>" class="btn btn-warning">
                            <i class="fa fa-pencil-square-o"></i> แก้ไขข้อมูล</a>
                        </td width="60">
                        <td><a href="?del_id=<?php echo $row['uuid'] ?>" class='btn btn-danger' onClick="return confirm('คุณต้องการที่จะลบข้อมูลนี้หรือไม่ ?');"> <i class="glyphicon glyphicon-trash"></i> ลบข้อมูล</a></td>
