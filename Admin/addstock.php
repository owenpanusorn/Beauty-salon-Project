...
<head>
  ...
  <title>Add Stock | Beautiful Salon</title>
...
<header class="main-header">
  ...
  <div class="content-wrapper">
    ...
    <form role="form" action="/api/add" method="POST" enctype="multipart/form-data">
      <div class="row">
        <div class="col-xs-12">      
      <!-- ข้อมูลส้วนตัว -->
        <div class="box box-success">
              ...
              <!-- form start -->              
                  ...
                  <label for="title">Name Product</label>
                    <div class="input-group">
                       <div class="input-group-addon">
                          ...
                          <input type="text" class="form-control" id="nameproduct" name="nameproduct" placeholder="Enter Name Product">
                    </div>
                  </div>               
                ...
                <div class="form-group">                    
                    <label>Stock</label>
                      ...
                      <input type="number" class="form-control" id="stock" name="stock" min="0" max="100">
                     </div>                                     
                </div>
              ...
              <!-- /.form group -->        
                ...
                <div class="box-footer">
                  <button type="submit" class="btn btn-success"><i class="fa fa-cart-plus"></i> Stock</button>
                </div>             
            </div>
        <!-- /ข้อมูลส้วนตัว -->          
        </div>
