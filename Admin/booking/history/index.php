                ...
                <ul class="sidebar-menu kanitB" data-widget="tree">
                    ...
                    <li class="treeview active">
                        ...
                        <ul class="treeview-menu">
                            <li><a href="../databooking/"><i class="fa  fa-info"></i>ข้อมูลการจองคิว</a></li>
                            <li><a href="../confirm/"><i class="fa  fa-spinner"></i>อนุมัติการจอง
                                    <span class="pull-right-container">
                                        <span class="label label-primary pull-right"><?php if (!empty($_SESSION["token_admin_uuid"])) echo $count ?></span>
                                    </span>
                                </a></li>
                            <li class="active"><a href="index.php"><i class="fa fa-history"></i>ประวัติการจอง</a></li>
                        ...
                        <div class="box">
                            ...
                            <div class="box-body">
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        <?php
                                        $result = $db->prepare('SELECT * from tb_booking where book_st = :book_st order by cre_bks_date desc');
